...
public extension CustomizableNavigation where Self: UIViewController, Self: UIGestureRecognizerDelegate {
    ...
    func updateNavigation() {
        ...
        titleTextAttributes[kCTForegroundColorAttributeName as NSAttributedStringKey] = titleColor
        titleTextAttributes[kCTFontAttributeName as NSAttributedStringKey] = titleFont
